...
/**
 * CollapsingToolbarLayout is a wrapper for {@link MaterialToolbar} which implements a collapsing app bar.
 ...
 * collapsing as it allows the {@link MaterialToolbar} to be fixed in place even though this layout is
...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                ...
                com.mcal.multilinecollapsingtoolbar.R.style.Widget_Design_MultilineCollapsingToolbar);
        // END MODIFICATION

        mCollapsingTextHelper.setExpandedTextGravity(
                a.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleGravity,
                        GravityCompat.START | Gravity.BOTTOM));
        mCollapsingTextHelper.setCollapsedTextGravity(
                a.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_collapsedTitleGravity,
        ...
        mCollapsingTextHelper.setCollapsedTextAppearance(
                com.mcal.multilinecollapsingtoolbar.R.style.ActionBar_Title);
        // END MODIFICATION
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this,
                new androidx.core.view.OnApplyWindowInsetsListener() {
                    @NonNull
                    @Override
                    public WindowInsetsCompat onApplyWindowInsets(@NonNull @NotNull View v, @NonNull @NotNull WindowInsetsCompat insets) {
                        return onWindowInsetChanged(insets);
                    }
                });

        // BEGIN MODIFICATION: set the value of maxNumberOfLines attribute to the mCollapsingTextHelper
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.mcal.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarLayoutExtension, defStyleAttr, 0);
        mCollapsingTextHelper.setMaxLines(typedArray.getInteger(com.mcal.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarLayoutExtension_maxLines, 3));
        mCollapsingTextHelper.setLineSpacingExtra(typedArray.getFloat(com.mcal.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarLayoutExtension_lineSpacingExtra, 0));
        mCollapsingTextHelper.setLineSpacingMultiplier(typedArray.getFloat(com.mcal.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarLayoutExtension_lineSpacingMultiplier, 1));
        typedArray.recycle();
        // END MODIFICATION
    }
    ...
    @NotNull
    static ViewOffsetHelper getViewOffsetHelper(@NotNull View view) {
     ...
     * given view.
     */
    private View findDirectChild(@NotNull final View descendant) {
